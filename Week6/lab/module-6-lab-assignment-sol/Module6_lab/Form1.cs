...
namespace Module6_lab
{
    public partial class Form1 : Form
    {
        ...
        private void txt_number1_TextChanged(object sender, EventArgs e)
        {
            ...
            //YOUR CODE GOES HERE
            if (IsValidInteger(txt_number1.Text, out number1) == false)
            {
        ...
        private void txt_number2_TextChanged(object sender, EventArgs e)
        {
            ...
            //YOUR CODE GOES HERE
            if (IsValidInteger(txt_number2.Text, out number2) == true)
            {
                IsValidInteger(txt_number2.Text, out number2);
            }
            else if (IsValidInteger(txt_number2.Text, out number2) == false)
            {
                MessageBox.Show("Invalid Entry");
            }
        ...
        private void btn_calculate_Click(object sender, EventArgs e)
        {
            ...
            //YOUR CODE GOES HERE
            if (cmb_operation.SelectedItem == "+")
            {
                result = number1 + number2;
            }
            else if (cmb_operation.SelectedItem == "-")
            {
                result = (number1 - number2);
            }
            else if (cmb_operation.SelectedItem== "*")
