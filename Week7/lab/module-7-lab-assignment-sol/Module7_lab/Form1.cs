...
namespace Module6_lab
{
    public partial class Form1 : Form
    {
        ...
        private void CopyArraysToLists()
        {
            ...
            foreach (string student1 in section1_array)
            {
                section1.Add(student1);
            }

            foreach (string student2 in section2_array) // Kodu değiştirdim
            {
        ...
        private void BindSectionData()
        {
            ...
            //YOUR CODE GOES HERE
            foreach (string student1 in section1)
            {
                lst_section1.Items.Add(student1);
            }

            //Use a loop to add items inside section2 list to lst_section2 listbox
            //YOUR CODE GOES HERE
            foreach (string section2 in section2_array)
            {
                lst_section2.Items.Add(section2);
            }
        ...
        private void CheckOverlappingItems()
        {
            ...
            for (int index1 = 0; index1 < section1.Count; index1++)//outer loop will traverse lst_section1
            {
                for (int index2 = 0; index2 < section2.Count; index2++)//inner loop will traverse lst_section1
                {
                    //Check if the traversed items matches 
                    if (lst_section1.Items[index1].ToString() == lst_section2.Items[index2].ToString())
                    {
        ...
        private void CompareListSize()
        {
            ...
            {
                lbl_sizeComparison.Text = "Lists contain the same number of items.";
                lbl_sizeComparison.ForeColor = Color.Red;
            }
            else if (section1.Count != section2.Count)
            {
        ...
        private void btn_moveToRight_Click(object sender, EventArgs e)
        {
            ...
            foreach (int x in lst_section1.SelectedIndices)
            {
                ...
                //YOUR CODE GOES HERE
                if (section2.Contains(itemToBemoved) == false)
                {
                    section2.Insert(itemToBemoved, 0);
                }
        ...
        private void btn_moveToLeft_Click(object sender, EventArgs e)
        {
            ...
            foreach (int x in lst_section2.SelectedIndices)
            {
                ...
                if (section1.Contains(itemToBemoved) == false)
                {
                    section1.Insert(itemToBemoved, 0) ;
                }
